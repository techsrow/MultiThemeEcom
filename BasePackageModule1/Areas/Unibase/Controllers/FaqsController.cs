...
namespace BasePackageModule1.Areas.Unibase.Controllers
{
    ...
    public class FaqsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FaqQuestion,FaqAns")] Faq faq)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FaqQuestion,FaqAns")] Faq faq)
        {
            if (id != faq.Id)
            {
                return NotFound();
