    ...
    public class SliderImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create(List<IFormFile> images,SliderImage slider)
        {
            ...
            foreach (IFormFile item in images)
            {
                ...
                var image = new SliderImage()
                { 
                   

                    Image = $"/img/slider/{imageName}" 

                };
                image.SliderTitle = slider.SliderTitle;
                image.BtnLink = slider.BtnLink;
                image.BtnText = slider.BtnText;
                image.Description = slider.Description;
