...
namespace BasePackageModule2.Areas.TomBase.Controllers
{
    ...
    public class MediasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var post = await _context.Medias
        ...
        public async Task<IActionResult> Create(IFormFile formImage, Media post)
        {
            if (ModelState.IsValid)
            {
                ...
                post.Image = $"/img/Media/{imageName}";
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var post = await _context.Medias.FindAsync(id);
            if (post == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, IFormFile image, Media post)
        {
            if (id != post.Id)
            {
                return NotFound();
            }
            var thisPost = await _context.Medias.FirstAsync(p => p.Id == post.Id);
