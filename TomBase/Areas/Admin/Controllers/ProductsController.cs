        ...
        public async Task<IActionResult> Edit(int id, IFormFile mainImage, List<IFormFile> images, Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    thisProduct.sku = product.sku;
                    thisProduct.Essential = product.Essential;
                    thisProduct.Featured = product.Featured;
                    ...
                    thisProduct.Slug=UrlHelper.GetFriendlyTitle(product.Name);
