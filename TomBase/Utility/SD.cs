...
namespace BasePackageModule2.Utility
{
    public static class SD
    {
        ...
        public static Double discountedPrice(Coupon couponFromDb, double originalOrderToatal , out bool isUsed )
        {
            isUsed = false;
            if (couponFromDb == null) return originalOrderToatal;
